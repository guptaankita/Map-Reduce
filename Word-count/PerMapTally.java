...
//import PerTallyTask.IntSumReducer;
...
public class PerMapTally {
	...
	public static class TokenizerMapper extends
		...
		public void map(Object key, Text value, Context context)
			...
			// A HashMap is defined to store the count for each word in a map
			// call.
			...
			// At the end of each map call the word and it's corresponding
			// count(value) is emitted
			// Aggregation is performed at the map call level
